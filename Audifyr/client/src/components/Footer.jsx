      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <img src="/favicon.png" alt="Audifyr Logo" className="h-8 w-8 rounded-md" />


              <span className="text-2xl font-bold text-white">Audifyr</span>
            </div>
            <p className="text-gray-400 max-w-md">
              Transform your text into engaging audio content with the power of AI. 
              Perfect for learning, content creation, and accessibility.
            </p>
          </div>
        ...
        <div className="text-center text-gray-500">
          <p>&copy; 2025 Audifyr. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
